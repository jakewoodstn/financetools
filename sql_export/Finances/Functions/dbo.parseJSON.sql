-- Exported: 2026-06-21T21:55:41.442053+00:00
-- Schema:   dbo
-- Object:   parseJSON
-- Type:     SQL_TABLE_VALUED_FUNCTION
-- Created:  2014-12-10 15:57:16.463000
-- Modified: 2014-12-10 15:57:16.463000
     ...
     BEGIN /* WHILE PATINDEX */
      ...
      ELSE
        IF SUBSTRING(@value, 1, 6) = '@array'
          ...
          SELECT @name, @parent_id, @contents, SUBSTRING(@value, 7, 5), 'array'
